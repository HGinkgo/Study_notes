...
1. <img src="F:\Study_notes\CSAPP\src\ch02\images\image-20250806205900639.png" alt="image-20250806205900639" style="zoom:80%;" /> 

   答：下面代码主要来自配套实验材料，主要目的是 **展示不同类型数据在内存中的字节表示**。
